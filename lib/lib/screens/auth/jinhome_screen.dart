...
class JinhomeScreen extends StatefulWidget {
  const JinhomeScreen({Key? key}) : super(key: key);

  @override
  _JinhomeScreen createState() => _JinhomeScreen();
}

class _JinhomeScreen extends State<JinhomeScreen>
...
// Update the mealData here with new chart data
            ...
            SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(
                      height:
                      30), //carbonhydrates, protein, fat과 아침 점심 저녁 사이 공간
                  SizedBox(
                    height: 250,
  ...
  SfCircularChart _buildSmallCircularChart(
